...
# This class is intended to serve as a base class for creating sequences that
# can be generated once and called as routines and/or branched to from multiple
# locations. The caller must ensure that the routine has been generated prior
# to attempting to call it or branch to it.
class ReusableSequence(Sequence):
    ...
    # Generate the specified routine and record its starting address. The
    # routine will only be generated once, even if this method is called
    # multiple times. If the specified routine is dependent on any other
    # routines being generated first, this method will also generate those
    # routines.
    #
    #  @param aRoutineName The name of the routine to generate.
    #  @param kwargs The arguments to pass to generate<RoutineName>()
    ...
    # Call a routine that has previously been generated. A branch with link
    # instruction will be generated to jump to the routine.
    #
    #  @param aRoutineName The name of the routine to call.
    #  @param aSaveRegIndices The indices of any registers that need to be
    #       preserved. The link register will always be preserved, so it should
    #       not be specified.
    ...
    # Return the names of all routines that the specified routine directly
    # depends on. This method is used to determine whether any other routines
    ...
    # previously generated and ensuring all prerequisite routines have already
    # been generated.
    #
    #  @param aRoutineName The name of the routine to generate.
    #  @param kwargs The arguments to pass to generate<RoutineName>()
