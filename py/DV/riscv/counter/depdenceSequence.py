...
class depSequence(Sequence):
    ...
    def choiceMod(self, **kargs):
        generalDepDicts = {
            ...
            "Target Dependency": {
                "Target after source": 10,
                "Target after target": 0,
                "No target dependence": 0,
            },
            "Source Dependency": {
                "Source after source": 0,
                "Source after target": 10,
                "No source dependence": 0,
            },
            "Inter-Dependency Priority": {
                "The neareast": 0,
                "The farthest": 0,
                "Optimal": 10,
                "Random": 10,
            },
            "The Optimal Inter-Dependency Direction": {
                "From the nearest to the farthest": 50,
    ...
    def pointerchaseChoice(self, **kargs):
        generalDepDicts = {
            ...
            "Target Dependency": {
                "Target after source": 0,
                "Target after target": 0,
                "No target dependence": 10,
            },
            "Source Dependency": {
                "Source after source": 0,
                "Source after target": 10,
