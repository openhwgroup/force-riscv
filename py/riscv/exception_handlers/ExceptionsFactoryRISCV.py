...
from riscv.exception_handlers.FastSyncDispatcher import (
    DefaultFastSyncDispatcher,
)
from riscv.exception_handlers.PrivilegeLevelHandlerSetRISCV import (
    PrivilegeLevelHandlerSetRISCV,
)
from riscv.exception_handlers.SyncDispatcher import DefaultSyncDispatcher
from riscv.exception_handlers.ThreadHandlerSetRISCV import (
    ThreadHandlerSetRISCV,
)


# This class provides an interface for creating various objects necessary
# for the generation of exception handlers for the RISCV architecture.
class ExceptionsFactoryRISCV(ExceptionsFactory):
    ...
    def createPrivilegeLevelHandlerSet(
        ...
        return PrivilegeLevelHandlerSetRISCV(
