...
int main(int argc, char* argv[])
{
  ...
  ArchInfo* arch_info = new ArchInfoTest("ImageIOUnitTest");
  arch_info->SetSimulatorDLL("ImageIOUnitTest.so");
  arch_info_objs.push_back(arch_info);
  ...
  config->LoadConfigFile("config/image_printer_unit.config", argv[0]);
