...
class MainSequence(Sequence):
    ...
    def generate(self, **kargs):
        ...
        # be a power of 2. This 1st block tests smaller values of
        # size - 1 byte to 32 bytes.
        ...
        # Iterate through Size and Align values.  Force requires Align to
        # be a power of 2. This 2nd block tests larger values of size - 32K
        # to 8M.
