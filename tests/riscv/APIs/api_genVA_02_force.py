...
class MainSequence(Sequence):
    ...
    def generate(self, **kargs):
        ...
        for _ in range(16):
            ...
            self.notice('>>>>>>>>>>>  Size= {}     Align= {}     Type= {}     Bank= {}     Flatmap= {}     Range= {}'.format(theSize, theAlign, "D", 0, 1, theAddressRange))
            rand_VA = self.genVA(Size=theSize, Align=theAlign, Type="D", Bank=0, FlatMap=1, Range=theAddressRange)

            self.notice(">>>>>> Requested Address Range:  {:<30s}       Returned VA:  {:016X}".format(theAddressRange, rand_VA))
