...
control_items = [ {"fname":"APIs/_def_fctrl.py",     "generator" : {"--cfg" : "config/riscv.config", }},
                  ...
                  {"fname":"instructions/c_instructions_rv64only/_def_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  {"fname":"instructions/c_instructions_rv64only/_noiss_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
