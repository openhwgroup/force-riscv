...
control_items = [ {"fname":"APIs/_def_fctrl.py",     "generator" : {"--cfg" : "config/riscv.config", }},
                  ...
                  {"fname":"instructions/g_instructions/_def_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  {"fname":"instructions/g_instructions/_noiss_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  {"fname":"instructions/g_instructions_rv64/_def_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  {"fname":"instructions/g_instructions_rv64/_noiss_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  ...
                  {"fname":"instructions/c_instructions_rv64/_def_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
                  {"fname":"instructions/c_instructions_rv64/_noiss_fctrl.py", "generator" : {"--cfg" : "config/riscv.config", }},
