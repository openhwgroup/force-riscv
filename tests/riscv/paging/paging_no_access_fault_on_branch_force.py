...
## This test verifies that the PageFaultModifier does not unintentionally induce access faults on
# branch instructions.
class MainSequence(Sequence):
    ...
    def generate(self, **kwargs):
        ...
        # The PageFaultModifier alters the page size choices, so we need to set the desired values
        # after applying the page fault modifications
        ...
        if satp_info['Width'] == 32:
            ...
            choices_mod.modifyPagingChoices('Page size#4K granule#S#stage 1', {'4K': 1, '2M': 10, '1G': 10, '512G': 10})
