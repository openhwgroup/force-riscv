...
#  This test verifies that a quad-widening integer multiply-add vector
#  instruction can be generated and executed. It verifies that the initial
# values are correctly communicated to the simulator and that the resulting
# values are successfully returned. The test assumes the use of 512-bit vector
...
class MainSequence(VectorTestSequence):
    ...
    # Initialize all vector registers and populate a list of lists of 64-bit
    # element values.
    ...
    # instruction are updated wtih the expected values.
    #
