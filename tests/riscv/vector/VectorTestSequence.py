...
class VectorTestSequence(Sequence):
    ...
    #
    #  @param aRegIndexA The starting register index of one of the register
    #       groups.
    #  @param aRegIndexB The starting register index of one of the register
    #       groups.
    #  @param aRegCountMultipleA The register count multiple for one of the
    #       register groups. For example, the destination register group in a
    #       widening instruction has a multiple of 2.
    #  @param aRegCountMultipleB The register count multiple for one of the
    #       register groups. For example, the destination register group in a
    #       widening instruction has a multiple of 2.
    def assertNoRegisterOverlap(
        self,
        aInstr,
        aRegIndexA,
        aRegIndexB,
        aRegCountMultipleA=1,
        aRegCountMultipleB=1,
    ):
    ...
    #
    #  @param aRegCountMultiple The register count multiple for the register
    #       group. For example, the destination register group in a widening
    #       instruction has a multiple of 2.
