...
# This test verifies that multithreaded execution runs smoothly when APIs are
# called that use ThreadContextNoAdvance on the back end.
class MainSequence(Sequence):
    ...
    # Call a variety of ConstraintSet methods, which should utilize
    # ThreadContextNoAdvance.
