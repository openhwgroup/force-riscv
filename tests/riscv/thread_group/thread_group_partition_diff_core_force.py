...
# This test verifies the different core partition strategy. This test assumes
# exactly 2 threads per core are used. We expect no two threads in a given
# thread group to belong to the same core.
