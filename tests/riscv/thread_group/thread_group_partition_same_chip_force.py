...
## This test verifies the same chip partition strategy. This test assumes exactly 2 chips are used.
# We expect all threads in a given thread group to belong to the same chip.
