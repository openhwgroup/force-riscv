...
class MainSequence(Sequence):
    ...
    def genEnableMisalignedBranches(self):
        ...
        # read misa, mask out C bit (to disable compressed instr set), write misa back...
        ...
        self.genInstruction('CSRRW#register#RISCV', {'rd': 0, 'rs1': gpr1, 'csr': self.getRegisterIndex('misa') })
    ...
    def genMisalignedBranch(self, branch_instrs):
        self.genInstruction(self.choice(branch_instrs), { "BRTarget" : self.genMisalignedInstrAddress() } )


    # if in privileged mode, attempt to generate an exception return instr, with a misaligned return address...
    ...
    def generate(self, **kargs):
        ...
        # try to issue an exception return instr, with misaligned address. we don't expect an exception...
