...
## This test verifies the instructions generated by AssemblyHelperRISCV yield the expected results.
class MainSequence(Sequence):
    ...
    def generate(self, **kargs):
        ...
        imm_val = RandomUtils.random32(0, 2047)
        assembly_helper.genAndImmediate(dest_reg_index, imm_val, aSrcRegIndex=src_reg_index)
        ...
        imm_val = RandomUtils.random32(0, 2047)
        assembly_helper.genOrImmediate(dest_reg_index, imm_val, aSrcRegIndex=src_reg_index)
        dest_reg_val = src_reg_val | imm_val
        exception_handlers_test_utils.assertGprHasValue(self, dest_reg_index, dest_reg_val)
        ...
        imm_val = RandomUtils.random32(0, 2047)
        assembly_helper.genXorImmediate(dest_reg_index, imm_val, aSrcRegIndex=src_reg_index)
        dest_reg_val = src_reg_val ^ imm_val
        exception_handlers_test_utils.assertGprHasValue(self, dest_reg_index, dest_reg_val)
        ...
        imm_val = RandomUtils.random32(0, 2047)
        assembly_helper.genAddImmediate(dest_reg_index, imm_val, aSrcRegIndex=src_reg_index)
        ...
        assembly_helper.genAndRegister(dest_reg_index, src_reg_index, aSrcRegIndex2=src_reg_index_2)
        ...
        assembly_helper.genOrRegister(dest_reg_index, src_reg_index, aSrcRegIndex2=src_reg_index_2)
        dest_reg_val = src_reg_val_2 | src_reg_val
        exception_handlers_test_utils.assertGprHasValue(self, dest_reg_index, dest_reg_val)
        ...
        assembly_helper.genNotRegister(dest_reg_index, aSrcRegIndex=src_reg_index)
        ...
        assembly_helper.genAddRegister(dest_reg_index, src_reg_index, aSrcRegIndex2=src_reg_index_2)
        ...
        assembly_helper.genSubRegister(dest_reg_index, src_reg_index, aMinuendRegIndex=src_reg_index_2)
        dest_reg_val = (src_reg_val_2 - src_reg_val) & MAX_GPR_VAL
        exception_handlers_test_utils.assertGprHasValue(self, dest_reg_index, dest_reg_val)
        ...
        if mscratch_val != src_reg_val:
            self.error('Value of register mscratch did not match the expected value. Expected=0x%x, Actual=0x%x' % (src_reg_val, mscratch_val))
