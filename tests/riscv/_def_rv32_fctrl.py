...
control_items = [ {"fname":"rv32/_def_fctrl.py",     "generator" : {"--cfg" : "config/riscv.config32", }},
                  ...
                  {"fname":"instructions/g_instructions/_def_fctrl.py", "generator" : {"--cfg" : "config/riscv.config32", }},
                  {"fname":"instructions/g_instructions/_noiss_fctrl.py", "generator" : {"--cfg" : "config/riscv.config32", }},
