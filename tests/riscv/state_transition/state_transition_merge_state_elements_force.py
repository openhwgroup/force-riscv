...
class MainSequence(Sequence):
    ...
    def generate(self, **kargs):
        ...
        StateTransition.registerStateTransitionHandler(state_trans_handler, EStateTransitionType.Explicit, (EStateElementType.Memory, EStateElementType.SystemRegister, EStateElementType.FloatingPointRegister))
