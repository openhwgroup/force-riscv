...
class MainSequence(Sequence):
    ...
    # Compute the expected target address for a JAL instruction given the
    ...
    def _getExpectedTargetAddress(self, aOrigPc, aOffsetOprValue):
        ...
        # process negative/positive 20b simm value | offset is multiple of 2
        # bytes, so lsh 1 gets the true byte offset
