...
namespace Force {
  ...
  */
  ...
  protected:
    ...
    void GetBranchToSelfSequence(std::vector<GenRequest* >& req_seq); //!< Provide an instruction sequence to branch to self.
    ...
    void EndOfTest() override; //!< Override base class for EndOfTest sequence.
