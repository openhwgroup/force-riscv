...
namespace Force {
  ...
  */
  ...
  public:
    ...
    void SetSegmentedRegisterSize(const VectorLayoutOperandStructure& rVecLayoutOprStruct, VectorLayout& rVecLayout);  //!< Sets the proper register size for segmented instructions.
