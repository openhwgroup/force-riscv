...
enum_classes_details = [
     ...
     ["VmConstraintType", "unsigned char", "Virtual memory constraint types.",
      [("Existing", 0), ("AddressError", 1), ("ReadOnly", 2), ("NoExecute", 3), ("PrivilegedNoExecute", 4), ("UnprivilegedNoExecute", 5), ("NoUserAccess", 6), ("PageTable", 7), ("UserAccess", 8), ("PageFault", 9), ("FlatMap", 10), ("AccessFault", 11), ("NoDataAccess", 12), ("NotAccessed", 13), ("NotDirty", 14)]
      ],
