...
enum_classes_details = [
    ...
    [
        ...
        [
            ...
            ("Filler", 1 << 10),
            ("Speculative", 1 << 11),
            ("AddressShortage", 1 << 12),
            ("RecordingState", 1 << 13),
            ("RestoreStateLoop", 1 << 14),
        ],
    ],
    [
        "GenStateType",
