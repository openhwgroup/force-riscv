...
//      const char* reg_name -- should be an allocated pointer to a character buffer sufficient to hold any relevant register name
...
//
int read_simulator_register(int target_id, const char* reg_name, uint8_t* value, int length);
...
// write_simulator_register function: for the given target_id, reg_name write the supplied reg_data of length num bytes into the corresponding simulator register
//
//  inputs:
//      int target_id -- refers to the processor id
//      const char* reg_name -- refers to the registers architectural name (not the programmers name) and ordinal
...
//
int write_simulator_register(int target_id, const char* reg_name, const uint8_t* data, int length); 

// write_simulator_register_fpix function: for the given target_id, reg_name write the supplied reg_data of length num bytes into the corresponding simulator register
//
//  inputs:
//      int target_id -- refers to the processor id
