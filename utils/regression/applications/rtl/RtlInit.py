...
class RtlAppOptions(object):
    ...
    cOptions = [        # |                     |                              |
        ...
        ApplicationOption('exe'               , 'uvm_simv_opt'               , 'RTL_EXE' ),  # Allow specifying a different simulation executable
        ApplicationOption('report_script_path', '/utils/regression/report.py', ''        ),  # Specify the relative location of the reporting script
        ApplicationOption('rtl_metrics_path'  , '~/force_regr_cycle_count'   , ''        ),  # file to save cycle count and instruction count
