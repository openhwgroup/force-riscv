...
class FpixCmdLineOptions(object):
    ...
    cOptions = [
        AppPathCmdLineOption(
            ...
            1,
            None,
            "- Specify Fpix ISS .so path.  When present, overrides the "
            'default simulator path\nIf not present then the "ISS_SO_PATH" '
            "environmental variable is used.\nIf the environmental variable "
            "does not exist then the default is used.\nIf a relative path is "
            "specified that path is calculated in the same manner as the "
            "default above",
            None,
            "ISS_SO_PATH",
        ),
        AppPathCmdLineOption(
            ...
            1,
            None,
            "- Specify Fpix executable path.  "
            "When present, overrides the default Fpix executable path",
            None,
            None,
        ),
        AppPathCmdLineOption(
            "cfg",
            "../../fpix/config/riscv_rv64.config",
            1,
            None,
