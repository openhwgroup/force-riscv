...
from test_critical_section import UnitTest_HiCriticalSection
from test_event import UnitTest_HiEvent
from test_queue import UnitTest_HiQueues
from test_stack import UnitTest_HiStack
...
class UnitTestRun( ModuleRun ):
    ...
    def __init__(self, arg_force_dir):
        super().__init__( arg_force_dir, CmdLine.Switches, CmdLine.ShortOpts, CmdLine.Switches[CmdLine.msg_lev], Defaults.msg_level, CmdLine.MsgLevel )
    ...
    def process_cmdline( self ):
        self.process_max = int( self.option_def( CmdLine.Switches[CmdLine.process_max], Defaults.process_max, CmdLine.ProcessMax ))

    def run(self):
        Msg.dbg( "ThreadTestRun::run()" )
        with UnitTest_HiThread(): pass
        with UnitTest_HiEvent(): pass
        with UnitTest_HiMutex():  pass
        # with UnitTest_HiSemaphore(): pass
        # with UnitTest_HiCriticalSection(): pass
        # with UnitTest_HiQueues(): pass
        # with UnitTest_HiStack(): pass

    # checks for usage requests and performs the initial validation of the command line
    def check_usage(self):
        # validate arguments
        if self.option_def( CmdLine.Switches[CmdLine.help], False, CmdLine.Help ):
