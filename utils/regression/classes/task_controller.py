...
class TaskController(Controller):
    ...
    def load( self, arg_ctrl_item ):
        ...
        self.task_list = PathUtils.list_files( PathUtils.append_path( self.ctrl_item.fctrl_dir, self.ctrl_item.fctrl_name ))
        #
    ...
    def process_task_file( self,  arg_task_file, aParentDir):
        try:
            ...
            full_task_dir = PathUtils.append_path(PathUtils.include_trailing_path_delimiter(aParentDir), my_task_dir)
    ...
    def process_task( self, arg_task_file, aTaskDir ):
        try:
            ...
            sub_task_dir = PathUtils.append_path(PathUtils.include_trailing_path_delimiter(aTaskDir), "%05d" % my_ndx)
            ...
            my_queue_item = ProcessQueueItem( sub_task_dir, self.ctrl_item, self.mAppsInfo, my_content  )
