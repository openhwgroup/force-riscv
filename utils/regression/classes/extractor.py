...
#
# extract.py
# comment: this is the abstract for classes that contain the extracted results
#       created from the process log file
...
class Extractor(object):
    ...
    def load(self, arg_request, arg_response):
        ...
        raise AbstractionError(
            "Abstract Method Error: Extractor::load(...) not implemented "
    ...
    def report(self):
        Msg.error_trace()
        raise AbstractionError(
            "Abstract Method Error: Extractor::report(...) not implemented "
            "in descendent [%s]" % (str(type(self)))
        )
    ...
    def publish(self, arg_sum_lev):
        Msg.error_trace()
        raise AbstractionError(
            "Abstract Method Error: Extractor::publish(...) not implemented "
            "in descendent [%s]" % (str(type(self)))
        )
    ...
    def has_error(self):
        Msg.error_trace()
        raise AbstractionError(
            "Abstract Method Error: Extractor::has_error(...) not implemented "
            "in descendent [%s]" % (str(type(self)))
        )
    ...
    def error_msg(self):
        Msg.error_trace()
        raise AbstractionError(
            "Abstract Method Error: Extractor::error_msg(...) not implemented "
            "in descendent [%s]" % (str(type(self)))
        )
    ...
    def result(self):
        Msg.error_trace()
        raise AbstractionError(
            "Abstract Method Error: Extractor::result(...) not implemented in "
            "descendent [%s]" % (str(type(self)))
        )
