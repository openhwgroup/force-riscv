...
master_config = {
    'rtl': {
        ...
        "add_meta_args":"force_init=on rvbar=80001000 inject_rand_interrupt=on rand_int_type=1 int_deassert_high=100 int_deassert_low=50 int_assert_high=200 int_assert_low=100", # Add more meta args to default meta args
        "filter":True, 
    },
    'generate': {},
    'iss': {}
