        ...
        try:
            ...
            if arg_timeout is None or not SysUtils.is_numeric( arg_timeout ) :
                ...
                try:
                    ...
                    try:
                        Msg.err('Timeout after %d seconds, terminating process: %s' % (arg_timeout, my_process_cmd))
                        my_parent_pgid = os.getpgid(0)
                        my_pgid = os.getpgid(my_pid)
                        ...
                        my_result = my_process.communicate()
                        Msg.flush()
                        return ( my_process.returncode, None, "Process Timeout Occurred", my_start_time, my_start_time, SysUtils.PROCESS_TIMEOUT )
            ...
            return ( my_process.returncode, my_stdout, my_stderr, my_start_time, my_end_time, SysUtils.NORMAL )
