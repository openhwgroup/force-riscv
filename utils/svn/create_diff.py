...
def usage():
    usage_str = (
        """Create svn diff files to sync between different builds.
...
def create_diff():
    ...
    if compare_dir is not None and not os.path.isdir(compare_dir):
